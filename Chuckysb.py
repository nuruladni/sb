...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EtGshAZ9x8C9taorwWwd.oegmIeewgG88VrXTAbiEpq.pgQuCSlXGRsbfRvwzmMZUnjWuFkjpL/QpXnzxOpuNlU=')
nadya.loginResult()
...
●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
 ...
 ●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
✯͜͡❂➣〘google (Text)〙
✯͜͡❂➣〘playstore-NamaApp〙
✯͜͡❂➣〘fancytext: Text〙
✯͜͡❂➣〘Musik-Judul-Penyanyi〙
✯͜͡❂➣〘smule-IDsmule〙
✯͜͡❂➣〘twitter-Username〙
✯͜͡❂➣〘ig-Username〙
✯͜͡❂➣〘yt Judul Video〙
✯͜͡❂➣〘ytsearch: Judul Video〙
✯͜͡❂➣〘image NamaGambar〙
●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
"""
...
●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
"""
tjia="u38418c8841161a0f3cbd1c6d68121e3d"
...
Bots=[mid]
Creator=["u38418c8841161a0f3cbd1c6d68121e3d"]
admin=["u38418c8841161a0f3cbd1c6d68121e3d"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Ramoet\nContact Me : 👉 line.me/ti/p/~clonexxxx",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        nadya.sendText(op.param1, "Haii " + Name +  "\nNgintip mulu ishh kamuuhh... syuka yaa 😁😁   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                    else:
                                        nadya.sendText(op.param1, "dooorr " + "☞ " + Name + " ☜" + "\nTuh kan kena...gelantungan mulu sihh kamuhh 😅😅😅   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                else:
                                    nadya.sendText(op.param1, "Nahh...ada " + "☞ " + Name + " ☜" + "\nNgapain Kak Ngintip Aja???\nSini Gabung Chat...   ")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Yang suka nyolek, akuhh sumpahin jerawatan 😝😝😝"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention3"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Hayy " + cName + ", Masih jones yak 😂😂😂"]
        ...
        if op.type == 25:
          if wait["Bot"] == True:    
			...
			nadya.sendText(msg.to,"Admin Detected~")
                ...
                nadya.sendMessage(msg)
		nadya.sendText(msg.to,"Itu Majikan Kami 😘😘")
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Sambutan 📱")
                else:
                    wait["Sambutan"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Status 📱")
                ...
                md = ""
		if wait["Sambutan"] == True: md+="✯͜͡❂➣ Sambutan : 📱\n"
		else:md+="✯͜͡❂➣ Sambutan :  📴\n"
		if wait["AutoJoin"] == True: md+="✯͜͡❂➣️ Auto Join : 📱\n"
                else: md +="✯͜͡❂➣ Auto Join : 📴\n"
		if wait["AutoJoinCancel"] == True: md+="✯͜͡❂➣ Auto Join Cancel : 📱\n"
                else: md +="✯͜͡❂➣ Auto Join Cancel : 📴\n"                
		if wait["Contact"] == True: md+="✯͜͡❂➣️ Info Contact : 📱\n"
		else: md+="✯͜͡❂➣ Info Contact : 📴\n"
                if wait["AutoCancel"] == True:md+="✯͜͡❂➣ Auto Cancel : 📱\n"
                else: md+= "✯͜͡❂➣ Auto Cancel : 📴\n"
                if wait["inviteprotect"] == True:md+="✯͜͡❂➣ Invite Protect : 📱\n"
                else: md+= "✯͜͡❂➣ Invite Protect : 📴\n"                
		if wait["Qr"] == True: md+="✯͜͡❂➣ Qr Protect : 📱\n"
		else:md+="✯͜͡❂➣ Qr Protect : 📴\n"
		if wait["AutoKick"] == True: md+="✯͜͡❂➣ Auto Kick : 📱\n"
		else:md+="✯͜͡❂➣ Auto Kick : 📴\n"
		if wait["alwaysRead"] == True: md+="✯͜͡❂➣ Always Read : 📱\n"
		else:md+="✯͜͡❂➣ Always Read: 📴\n"
		if wait["detectMention"] == True: md+="✯͜͡❂➣ Auto Respon1 : 📱\n"
		else:md+="✯͜͡❂➣ Auto Respon1 : 📴\n"		
		if wait["detectMention2"] == True: md+="✯͜͡❂➣️ Auto Respon2 : 📱\n"
		else:md+="✯͜͡❂➣ Auto Respon2 : 📴\n"	
		if wait["detectMention3"] == True: md+="✯͜͡❂➣ Auto Respon3 : 📱\n"
		else:md+="✯͜͡❂➣ Auto Respon3 : 📴\n"			
		if wait["kickMention"] == True: md+="✯͜͡❂➣️ Auto Respon Kick : 📱\n"
		else:md+="✯͜͡❂➣ Auto Respon Kick : 📴\n"				
		if wait["Sider"] == True: md+="✯͜͡❂➣️ Auto Sider : 📱\n"
		else:md+="✯͜͡❂➣ Auto Sider: 📴\n"	
		if wait["Simi"] == True: md+="✯͜͡❂➣ Simisimi : 📱\n"
		else:md+="✯͜͡❂➣ Simisimi: 📴\n"		
                nadya.sendText(msg.to,"●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●\n  ✪⊹⊱⋛⇚STATUS MODE⇛⋚⊰⊹✪\n●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●\n"+md+"●▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●")
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "u38418c8841161a0f3cbd1c6d68121e3d"
                nadya.inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
		    for i in gid:
			nadya.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~rama_def")
		...
		nadya.sendText(msg.to, "Sabar boskuhh...")
                nadya.sendText(msg.to, "%sseconds" % (elapsed_time))
                
            elif msg.text in ["Speed test"]:
                start = time.time()
                nadya.sendText(msg.to, "Sabar bosskuhh...")
                elapsed_time = time.time() - start
                nadya.sendText(msg.to, "%sseconds" % (elapsed_time))                
            ...
            elif msg.text.lower() == 'clearban':
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    nadya.sendText(msg.to,"Unbanned succes") 
		...
		if msg.from_ in Creator:
		    nadya.sendText(msg.to, "Wait...\nJembot sedang restart")
		    restart_program()
		    print "@Restart"
		else:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                try:
                    ...
                    #acil.sendImageWithURL(msg.to, tj)
                ...
                try:
                    ...
                    nadya.sendText(msg.to, str(hasil))                    
                except:
                    nadya.sendText(msg.to,"Selamat menonton 😊😘")
                   ...
                   if msg.from_ in admin:
                           try:
                                ...
                                params = {"judul": judul}
                                r = requests.get("http://farzain.xyz/api/premium/joox.php?apikey=al11241519&id="+urllib.urlencode(params))
                                data = r.text
                                data = json.loads(data)
                                info = data["info"]
                                audio = data["audio"]
                                ...
                                nadya.sendImageWithURL(msg.to, str(data["gambar"]))
                                nadya.sendText(msg.to, str(hasil))
                                nadya.sendText(msg.to, "Downloading...")
                                nadya.sendText(msg.to, "「 Result MP3 」")
                                nadya.sendAudioWithURL(msg.to, str(audio["mp3"]))
                                nadya.sendText(msg.to, "「 Result M4A 」")
                                nadya.sendVideoWithURL(msg.to, str(audio["m4a"]))
                                nadya.sendText(msg.to, str(data["lirik"]))
                                nadya.sendText(msg.to, "Success Download...")
                           except Exception as error:
                                pass
                                            
            elif "Ramoet telp " in msg.text:
                            try:
                                nohp = msg.text.replace("Ramoet telp ","")
                                np = nohp.rstrip('  ')
                                r = requests.get("http://farzain.xyz/api/prank().php?apikey=zJsZLz8s7e1PAiOuESLghxyuWpr1A4&id="+np+"&type=2")
                                nadya.sendText(msg.to, "「 Ramoet Telepon 」\n๑ Status : Success!!!\n๑ No Tujuan : "+np)
                            except Exception as error:
                                pass  
                            
	    elif "Ramoet sms " in msg.text:
                            try:
                                nohp = msg.text.replace("Ramoet sms ","")
                                np = nohp.rstrip('  ')
                                r = requests.get("http://farzain.xyz/api/prank().php?apikey=zJsZLz8s7e1PAiOuESLghxyuWpr1A4&id="+np+"&type=1")
                                nadya.sendText(msg.to, "「 Ramoet Sms 」\n๑ Status : Success!!!\n๑ No Tujuan : "+np)
                            except Exception as error:
                                pass
                    ...
                    nadya.sendText(msg.to, "https://www.twitter.com" + b)
                    nadya.sendText(msg.to,"「 Searching 」\n" "Type:Search Info\nStatus: Success") 
                    
            elif "Smule " in msg.text:
                    a = msg.text.replace("Smule ","")
                    b = urllib.quote(a)
                    nadya.sendText(msg.to,"Searching to id smule..")
                    nadya.sendText(msg.to, "Nama: "+b+"\nId smule: http://smule.com/" +b)
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Tikel"]:
                wait["sticker"] = True
                nadya.sendText(msg.to,"Ready check tikel")            
